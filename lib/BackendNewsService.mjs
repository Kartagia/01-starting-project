import { getAvailableNewsMonths, getAvailableNewsYears } from "./dummyNews.mjs";
...
export function getAvailableNewsMonths(year, ascending=false) {
  return defaultService.getAvailableMonthsOfYear(year, ascending);
}

export function getAvailableNewsYears(ascending=false) {
...
export default { getAvailableNewsMonths, getAvailableNewsYears, getNewsForYear, getNewsForYearAndMonth};
