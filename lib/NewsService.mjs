 ...
 * @module data/news/NewsService
 */
/**
 * Structure containing news article.
 * @template [ID=string] The identifier typeof the news article.
 ...
 * @property {ID} id The identifier of the article.
...
/**
 * A news entry with both identifier and the news article.
 * @template [ID=string] The identifier typeof the news article.
 * @typedef {[id: string, article: NewsArticle<ID>]} NewsEntry
 */
...
export class NewsService {
   ...
   * @param {(NewsArticle|[id: string, article: NewsArticle<ID>])[]} [articles] The initial articles.
   */
   ...
   * @returns {Promise<NewsArticle<ID>>} The promise of an article with id.
   */
  getOne(id) {
   ...
   * @returns {Promise<NewsEntry<ID>[]>} The all posts of the service.
   */
  getAll() {
 ...
 * @returns {Promise<NewsEntry<ID>[]>} The news articles in
 * specific month of a year.
   ...
   * @returns {Promise<NewsEntry[]>} The news articles in
   * specific month of a year.
  */
  ...
  */
   ...
   * @returns {Promise<NewsEntry[]>} The lastest news.
   */
