...
import { BetterSqlLiteDatabaseService } from "./SqlNewsSerivce.mjs";
 ...
 */
var unregisterFunction = undefined; 
...
export async function getAllNews() {
  return new Promise( async (resolve, reject) => {
    await setTimeout(() => {resolve(defaultService.getAll())}, 30000);
  });
}
...
registerNewsService(new BetterSqlLiteDatabaseService({databaseName:"data"}));
